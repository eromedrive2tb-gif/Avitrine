...
export const Badge: FC<BadgeProps> = ({ children, variant = 'default', className = '' }) => {
  const variants = {
    ...
    success: "bg-green-500/20 text-green-400 px-2 py-1 rounded text-xs font-medium border border-green-500/20",
    warning: "bg-yellow-500/20 text-yellow-400 px-2 py-1 rounded text-xs font-medium border border-yellow-500/20",
    danger: "bg-red-500/20 text-red-400 px-2 py-1 rounded text-xs font-medium border border-red-500/20",
    secondary: "bg-gray-500/20 text-gray-400 px-2 py-1 rounded text-xs font-medium border border-gray-500/20"
  };
