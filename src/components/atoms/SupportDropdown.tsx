...
export const SupportDropdown: FC = async () => {
        ...
        <div class="p-2 space-y-1">
          {contacts.map((contact) => (
            ...
            >
              ...
              <div>
                <p class="text-sm font-medium text-gray-200 group-hover/item:text-white">
                  {contact.platform === 'telegram' ? 'Telegram' : 'WhatsApp'}
                </p>
                <p class="text-[10px] text-gray-500">
                  {contact.platform === 'telegram' ? 'Resposta rápida' : 'Atendimento 24h'}
                </p>
              </div>
            </a>
          ))}
