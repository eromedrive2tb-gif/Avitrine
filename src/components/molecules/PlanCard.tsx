...
export const PlanCard: FC<PlanProps> = ({
  ...
  return (
    <div class={`relative p-8 rounded-2xl bg-surface${variant === 'outline' ? '/50 backdrop-blur-sm grayscale opacity-70 hover:grayscale-0 hover:opacity-100' : ' border border-white/10 hover:border-primary/50'} transition-all duration-300 ${className || ''}`}>
